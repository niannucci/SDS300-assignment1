...
```{r}
# importing data
raw_data <- read_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vQ9FlR9Jnryag3vJtrAD6O8vlkdO0jKpEUz2XHOCCDkc0DIqrNSgMyQUAM2RRfGFN8sxlbYSK64HAiH/pub?output=csv") %>%
  dplyr::select(-Timestamp)

# changing column names
colnames(raw_data) <- c("presence", "interaction", "life_affection", "sentiment", "verbal_attack", "emotional_attack", "physical_attack", "thinking", "feel", "explanation")
