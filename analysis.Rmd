...
use_data <- data %>% 
  dplyr::select(presence, interaction, life_affection, sentiment, verbal_attack,
                emotional_attack, physical_attack, thinking, feel)

adj_data <- as.data.frame(reverse.code(keys = key, items = use_data))
