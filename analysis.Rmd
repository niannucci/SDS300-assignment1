...
dich_data <- data %>% 
  select(presence_dich, interaction_dich, life_affection_dich, sentiment_dich, verbal_attack_dich, emotional_attack_dich, physical_attack_dich, thinking_dich, feel_dich)
